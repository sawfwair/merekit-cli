...
function commandManifest() {
  return {
    ...
    commands: [
      ...
      manifestCommand(["export"], "Export local donor-ledger transfer bundle.", { auth: "none", risk: "read" }),
      manifestCommand(["import"], "Import local donor-ledger transfer bundle.", { auth: "none", risk: "write" }),
      manifestCommand(["ledger", "publish"], "Publish selected local donor-ledger summary projection to Business.", { auth: "none", risk: "external", auditDefault: true }),
      manifestCommand(["ledger", "revoke"], "Revoke selected local donor-ledger summary projection from Business.", { auth: "none", risk: "external", auditDefault: true }),
