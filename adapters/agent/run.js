...
function commandManifest() {
  return {
    ...
    commands: [
      ...
      manifestCommand(["agent", "publish"], "Publish selected local agent metadata to the Business projection receiver.", { auth: "none", risk: "external" }),
      manifestCommand(["agent", "revoke"], "Revoke selected local agent metadata from the Business projection receiver.", { auth: "none", risk: "external" }),
      ...
      manifestCommand(["export"], "Export a local agent metadata transfer bundle.", { auth: "none", auditDefault: true }),
      manifestCommand(["import"], "Import a local agent metadata transfer bundle.", { auth: "none", risk: "write", requiresConfirm: true }),
      manifestCommand(["ai", "prompt"], "Run a local prompt through mere.run and record the AI job.", { auth: "none", risk: "write", supportsData: true }),
