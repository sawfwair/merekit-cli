...
| --- | ---: | ---: | --- | --- |
| `business` | 164 | 2 | 60 read, 72 write, 15 destructive, 17 external | `workspace`, `json`, `no-interactive`, `yes`, `confirm` |
...
| `email` | 48 | 6 | 20 read, 16 write, 4 destructive, 8 external | `base-url`, `business-base-url`, `workspace`, `store`, `ai`, `local-db`, `projection-url`, `projection-token`, `json`, `yes`, `confirm` |
